...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.log("Fetching menu list:", { page: safePage, limit: safeLimit, offset });
    ...
    console.log("Fetched menus count:", result.length);

    const convertedResult = convertBigIntToNumber(result);
    console.log("Converted result count:", convertedResult.length);
