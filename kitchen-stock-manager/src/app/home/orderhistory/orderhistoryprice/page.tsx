...
import { Clock, User, Package, FileText, Search, CalendarDays, Filter, Smartphone, Wallet, Map, Download, Users, Edit2 } from "lucide-react";
...
import { Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationNext, PaginationPrevious } from "@/share/ui/pagination";
    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50'>
      <div className='p-6'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 sm:w-full lg:grid-cols-4 gap-3 lg:w-1/2 lg:justify-self-end -mt-9 mb-5'>
          <Button onClick={handleorderhistoryprice} className='h-12 w-full rounded-lg border border-slate-300 shadow-sm text-sm break-words'>
                                            ...
                                            <div
                                              ...
                                              <div className='flex items-center gap-4'>
                                                <span className='text-gray-600'>
                                                  ใช้ {ing.ingredient_unit} บาท × {totalBox} กล่อง ={" "}
                                                  <strong
