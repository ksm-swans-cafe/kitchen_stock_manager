  ...
  return (
    <div className='flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6'>
      ...
      <div className='relative flex-1 w-full sm:w-auto'>
        <Input placeholder='Search Name Ingredients' value={searchTerm} onChange={handleSearch} className='pl-10 pr-4 py-2 w-full' />
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className='w-48'>
          <DropdownMenuRadioGroup value={selectedStatus || ""} onValueChange={handleStatusSelect}>
