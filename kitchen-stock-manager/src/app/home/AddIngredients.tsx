    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/10 to-background">
      ...
      <div className="w-full bg-secondary/20 border-b border-border/50">
        <div className="p-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span className="text-foreground font-medium">Add Ingredients</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center min-h-[calc(100vh-140px)] p-4">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-foreground mb-4">Add Ingredients</h2>
          <p className="text-muted-foreground">This page will contain the add ingredients functionality.</p>
        </div>
      </div>
    </div>
  );
